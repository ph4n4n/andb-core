# Integration Guide - andb-core

## Overview

andb-core provides programmatic API to integrate into your Node.js application.
...
class MyDatabaseService extends interfaces.IDatabaseService {
  ...
  // Determine destination environment
  getDestEnv(env) {
...
# 💡 Can be extended: ANDB_ENVIRONMENTS=DEV,STAGE,PROD
